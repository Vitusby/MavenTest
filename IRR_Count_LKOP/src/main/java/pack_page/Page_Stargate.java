...
public class Page_Stargate extends Page
{
	...
	@FindBy(xpath="//ul[@class='x-tree-root-ct x-tree-lines']//ul/li[23]/ul//a[@class='x-tree-node-anchor']/span[contains(text(),'Отдам даром')]")
	...
	public void OpenFormCreatePremiumFree() throws ExceptFailTest
	{
		...
		CheckElementPresent(1,"//ul[@class='x-tree-root-ct x-tree-lines']//ul/li[23]/ul//a[@class='x-tree-node-anchor']/span[contains(text(),'Отдам даром')]");
