...
public class Test_Mobile
{
	...
	@Parameters({"sBaseHost", "sLogin", "sPassword" , "sParam",  "sParam1",  "sParam2", "bAuthFlag"})
	public void Test5(String sBaseHost, String sLogin, String sPassword, String sParam, String sParam1, String sParam2, boolean bAuthFlag) throws URISyntaxException, IOException, ExceptFailTest, JSONException
	{
		...
		cM.PostAdvert_2_1(sBaseHost, sLogin, sPassword, sParam, sParam1, sParam2, "1.jpeg", bAuthFlag);
	}
